...
-- Date        : Mon Mar 11 17:14:55 2019
-- Host        : catabit-UX430UAR running 64-bit Ubuntu 16.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/catabit/Zybo/SDCar/SDCarVivado/SDCarVivado.srcs/sources_1/bd/design_1/ip/design_1_AXI_BayerToRGB_0_0/design_1_AXI_BayerToRGB_0_0_sim_netlist.vhdl
...
entity design_1_AXI_BayerToRGB_0_0_LineBuffer is
  port (
    ...
    \sPixel_reg[2][8]\ : out STD_LOGIC_VECTOR ( 8 downto 0 );
    StreamClk : in STD_LOGIC;
    sLineBufferWrite_reg : in STD_LOGIC;
    ADDRARDADDR : in STD_LOGIC_VECTOR ( 10 downto 0 );
    Q : in STD_LOGIC_VECTOR ( 9 downto 0 );
    \sLineBufferReadDataBuf_reg[8]\ : in STD_LOGIC_VECTOR ( 8 downto 0 )
  );
...
architecture STRUCTURE of design_1_AXI_BayerToRGB_0_0_LineBuffer is
  ...
  signal pLineBuffer_reg_n_75 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \sPixel[2][1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \sPixel[2][2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \sPixel[2][3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \sPixel[2][4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \sPixel[2][5]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \sPixel[2][6]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \sPixel[2][7]_i_1\ : label is "soft_lutpair0";
...
pLineBuffer_reg: unisim.vcomponents.RAMB36E1
    generic map(
      ...
      DOBDO(9) => pLineBuffer_reg_n_75,
      DOBDO(8 downto 0) => \^d\(8 downto 0),
...
\sPixel[2][0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I2 => \sLineBufferReadDataBuf_reg[8]\(0),
      O => \sPixel_reg[2][8]\(0)
    );
\sPixel[2][1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^d\(1),
      I1 => sLineBufferWrite_reg,
      I2 => \sLineBufferReadDataBuf_reg[8]\(1),
      O => \sPixel_reg[2][8]\(1)
    );
\sPixel[2][2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^d\(2),
      I1 => sLineBufferWrite_reg,
      I2 => \sLineBufferReadDataBuf_reg[8]\(2),
      O => \sPixel_reg[2][8]\(2)
    );
\sPixel[2][3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^d\(3),
      I1 => sLineBufferWrite_reg,
      I2 => \sLineBufferReadDataBuf_reg[8]\(3),
      O => \sPixel_reg[2][8]\(3)
    );
\sPixel[2][4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^d\(4),
      I1 => sLineBufferWrite_reg,
      I2 => \sLineBufferReadDataBuf_reg[8]\(4),
      O => \sPixel_reg[2][8]\(4)
    );
\sPixel[2][5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^d\(5),
      I1 => sLineBufferWrite_reg,
      I2 => \sLineBufferReadDataBuf_reg[8]\(5),
      O => \sPixel_reg[2][8]\(5)
    );
\sPixel[2][6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^d\(6),
      I1 => sLineBufferWrite_reg,
      I2 => \sLineBufferReadDataBuf_reg[8]\(6),
      O => \sPixel_reg[2][8]\(6)
    );
\sPixel[2][7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^d\(7),
      I1 => sLineBufferWrite_reg,
      I2 => \sLineBufferReadDataBuf_reg[8]\(7),
      O => \sPixel_reg[2][8]\(7)
    );
\sPixel[2][8]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^d\(8),
      I1 => sLineBufferWrite_reg,
      I2 => \sLineBufferReadDataBuf_reg[8]\(8),
      O => \sPixel_reg[2][8]\(8)
    );
end STRUCTURE;
library IEEE;
...
architecture STRUCTURE of design_1_AXI_BayerToRGB_0_0_AXI_BayerToRGB is
  ...
  signal LineBufferInst_n_9 : STD_LOGIC;
  ...
  signal sAXIMasterGreen1_in : STD_LOGIC_VECTOR ( 8 downto 1 );
  ...
  signal \sAXIMasterRed[7]_i_3_n_0\ : STD_LOGIC;
  signal \sAXIMasterRed[7]_i_4_n_0\ : STD_LOGIC;
  ...
  signal sLineBufferReadData : STD_LOGIC_VECTOR ( 8 downto 0 );
  signal sLineBufferReadDataBuf : STD_LOGIC_VECTOR ( 8 downto 0 );
  signal sLineBufferReadDataBuf_0 : STD_LOGIC;
  signal sLineBufferWriteData : STD_LOGIC_VECTOR ( 9 downto 0 );
  signal sLineBufferWriteDataDly : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  signal \NLW__inferred__4/i__carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW__inferred__4/i__carry__1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  attribute METHODOLOGY_DRC_VIOS : string;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \sAXIMasterRed[7]_i_4\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \sCntColumns[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \sCntColumns[2]_i_1\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \sCntColumns[8]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \sCntColumns[9]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \sCntLines[0]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \sCntRemPixels[0]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \sCntRemPixels[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \sOtherPixelsData[10]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \sOtherPixelsData[11]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \sOtherPixelsData[12]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sOtherPixelsData[13]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \sOtherPixelsData[15]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \sOtherPixelsData[20]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \sOtherPixelsData[21]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sOtherPixelsData[22]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \sOtherPixelsData[23]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \sOtherPixelsData[24]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sOtherPixelsData[25]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \sOtherPixelsData[26]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \sOtherPixelsData[27]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \sOtherPixelsData[28]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \sOtherPixelsData[29]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \sOtherPixelsData[2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \sOtherPixelsData[4]_i_1\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \sStrobesShiftReg[0][FirstColumn]_i_2\ : label is "soft_lutpair19";
...
LineBufferInst: entity work.design_1_AXI_BayerToRGB_0_0_LineBuffer
     port map (
      ...
      D(8 downto 0) => sLineBufferReadData(8 downto 0),
      Q(9 downto 0) => sLineBufferWriteData(9 downto 0),
      StreamClk => StreamClk,
      \sLineBufferReadDataBuf_reg[8]\(8 downto 0) => sLineBufferReadDataBuf(8 downto 0),
      sLineBufferWrite_reg => sLineBufferWrite_reg_n_0,
      \sPixel_reg[2][8]\(8) => LineBufferInst_n_9,
      \sPixel_reg[2][8]\(7) => LineBufferInst_n_10,
      \sPixel_reg[2][8]\(6) => LineBufferInst_n_11,
      \sPixel_reg[2][8]\(5) => LineBufferInst_n_12,
      \sPixel_reg[2][8]\(4) => LineBufferInst_n_13,
      \sPixel_reg[2][8]\(3) => LineBufferInst_n_14,
      \sPixel_reg[2][8]\(2) => LineBufferInst_n_15,
      \sPixel_reg[2][8]\(1) => LineBufferInst_n_16,
      \sPixel_reg[2][8]\(0) => LineBufferInst_n_17
    );
...
\_inferred__4/i__carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW__inferred__4/i__carry__1_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW__inferred__4/i__carry__1_O_UNCONNECTED\(3 downto 1),
      O(0) => sAXIMasterGreen1_in(8),
      S(3 downto 1) => B"000",
...
\sAXIMasterRed[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \sAXIMasterRed[7]_i_4_n_0\,
      I4 => m_axis_video_tready,
      I5 => \sStrobesShiftReg_reg[2][FirstColumn]__0\,
      O => \sAXIMasterRed[7]_i_1_n_0\
    );
\sAXIMasterRed[7]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AAA8"
    )
        port map (
...
\sAXIMasterRed[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFF0CCAA00F0CCAA"
    )
        port map (
      ...
      I4 => sCrntPositionIndicatorDly3(1),
      I5 => \sPixel_reg_n_0_[0][7]\,
      O => \sAXIMasterRed[7]_i_3_n_0\
    );
\sAXIMasterRed[7]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\sLineBufferReadDataBuf[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55570000"
    )
        port map (
...
architecture STRUCTURE of design_1_AXI_BayerToRGB_0_0 is
  ...
  attribute x_interface_parameter of s_axis_video_tready : signal is "XIL_INTERFACENAME AXI_Slave_Interface, TDATA_NUM_BYTES 5, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 150000000, PHASE 0.0, CLK_DOMAIN design_1_clk_wiz_0_0_clk_out1, LAYERED_METADATA undef";
