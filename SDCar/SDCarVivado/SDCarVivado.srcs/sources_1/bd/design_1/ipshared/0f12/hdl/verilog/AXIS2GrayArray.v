...
reg   [0:0] tmp_s_reg_426;
reg   [0:0] brmerge_reg_435;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter1;
wire    ap_block_pp2_stage0;
reg   [0:0] eol_2_reg_220;
reg    fifo1_blk_n;
reg    ap_enable_reg_pp1_iter3;
reg   [0:0] ap_reg_pp1_iter2_tmp_s_reg_426;
reg   [0:0] eol_reg_150;
reg   [10:0] xi_reg_162;
reg   [0:0] eol_1_reg_173;
reg   [23:0] axis_reader_data_V_1_reg_184;
reg   [0:0] axis_reader_last_V_2_reg_195;
reg   [23:0] axis_reader_data_V_2_reg_208;
reg   [0:0] axis_reader_last_V_3_reg_231;
reg   [23:0] axis_reader_data_V_3_reg_243;
reg   [23:0] tmp_data_V_reg_397;
reg   [0:0] tmp_last_V_reg_405;
wire   [0:0] exitcond_fu_274_p2;
wire    ap_CS_fsm_state4;
wire   [9:0] yi_1_fu_280_p2;
reg   [9:0] yi_1_reg_421;
...
reg   [0:0] ap_reg_pp1_iter1_tmp_s_reg_426;
wire   [10:0] xi_1_fu_292_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [0:0] brmerge_fu_301_p2;
wire   [22:0] p_s_fu_373_p2;
reg   [22:0] p_s_reg_439;
reg   [7:0] p_1_cast_reg_444;
reg   [7:0] tmp_3_reg_449;
wire   [7:0] phitmp2_fu_365_p3;
reg   [7:0] phitmp2_reg_454;
...
reg   [0:0] ap_phi_mux_eol_2_phi_fu_223_p4;
reg   [0:0] axis_reader_last_V1_reg_119;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state12;
reg   [23:0] axis_reader_data_V1_reg_129;
reg   [9:0] yi_reg_139;
reg   [0:0] ap_phi_mux_axis_reader_last_V_2_phi_fu_200_p4;
reg   [0:0] ap_phi_mux_eol_phi_fu_154_p4;
reg   [0:0] ap_phi_mux_eol_1_phi_fu_176_p4;
reg   [23:0] ap_phi_mux_axis_reader_data_V_1_phi_fu_187_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axis_reader_last_V_2_reg_195;
reg   [23:0] ap_phi_mux_axis_reader_data_V_2_phi_fu_212_p4;
wire   [23:0] ap_phi_reg_pp1_iter1_axis_reader_data_V_2_reg_208;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_fu_98;
wire   [7:0] r_V_fu_312_p1;
wire   [22:0] grp_fu_389_p3;
wire   [24:0] grp_fu_379_p3;
wire   [0:0] tmp_21_fu_349_p3;
wire   [7:0] tmp_8_fu_356_p4;
wire   [14:0] p_s_fu_373_p0;
wire   [7:0] p_s_fu_373_p1;
wire   [16:0] grp_fu_379_p0;
wire   [7:0] grp_fu_379_p1;
wire   [22:0] grp_fu_379_p2;
wire   [15:0] grp_fu_389_p0;
wire   [7:0] grp_fu_389_p1;
wire   [0:0] tmp_user_V_fu_265_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_block_state1;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
reg    ap_idle_pp2;
wire    ap_enable_pp2;
wire   [24:0] grp_fu_379_p10;
wire   [24:0] grp_fu_379_p20;
wire   [22:0] grp_fu_389_p10;
wire   [22:0] p_s_fu_373_p10;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond_fu_274_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((tmp_s_fu_286_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond_fu_274_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_phi_mux_eol_2_phi_fu_223_p4 == 1'd1) & (1'b0 == ap_block_pp2_stage0_subdone) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        axis_reader_data_V1_reg_129 <= axis_reader_data_V_3_reg_243;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        axis_reader_data_V1_reg_129 <= tmp_data_V_reg_397;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_fu_274_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        axis_reader_data_V_1_reg_184 <= axis_reader_data_V1_reg_129;
    end else if (((ap_reg_pp1_iter1_tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
        axis_reader_data_V_1_reg_184 <= axis_reader_data_V_2_reg_208;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_409)) begin
        if (((brmerge_reg_435 == 1'd1) & (tmp_s_reg_426 == 1'd0))) begin
            axis_reader_data_V_2_reg_208 <= ap_phi_mux_axis_reader_data_V_1_phi_fu_187_p4;
        end else if (((brmerge_reg_435 == 1'd0) & (tmp_s_reg_426 == 1'd0))) begin
            axis_reader_data_V_2_reg_208 <= axis_src_V_data_V_0_data_out;
        end else if ((1'b1 == 1'b1)) begin
            axis_reader_data_V_2_reg_208 <= ap_phi_reg_pp1_iter1_axis_reader_data_V_2_reg_208;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        axis_reader_data_V_3_reg_243 <= axis_reader_data_V_1_reg_184;
    end else if (((eol_2_reg_220 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
        axis_reader_data_V_3_reg_243 <= axis_src_V_data_V_0_data_out;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        axis_reader_last_V1_reg_119 <= axis_reader_last_V_3_reg_231;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        axis_reader_last_V1_reg_119 <= tmp_last_V_reg_405;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_409)) begin
        if (((brmerge_reg_435 == 1'd1) & (tmp_s_reg_426 == 1'd0))) begin
            axis_reader_last_V_2_reg_195 <= ap_phi_mux_eol_1_phi_fu_176_p4;
        end else if (((brmerge_reg_435 == 1'd0) & (tmp_s_reg_426 == 1'd0))) begin
            axis_reader_last_V_2_reg_195 <= axis_src_V_last_V_0_data_out;
        end else if ((1'b1 == 1'b1)) begin
            axis_reader_last_V_2_reg_195 <= ap_phi_reg_pp1_iter1_axis_reader_last_V_2_reg_195;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        axis_reader_last_V_3_reg_231 <= eol_1_reg_173;
    end else if (((eol_2_reg_220 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
        axis_reader_last_V_3_reg_231 <= axis_src_V_last_V_0_data_out;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_fu_274_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        eol_1_reg_173 <= axis_reader_last_V1_reg_119;
    end else if (((ap_reg_pp1_iter1_tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
        eol_1_reg_173 <= axis_reader_last_V_2_reg_195;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        eol_2_reg_220 <= eol_reg_150;
    end else if (((eol_2_reg_220 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
        eol_2_reg_220 <= axis_src_V_last_V_0_data_out;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_274_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        eol_reg_150 <= 1'd0;
    end else if (((tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        eol_reg_150 <= ap_phi_mux_axis_reader_last_V_2_phi_fu_200_p4;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_s_fu_286_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_fu_98 <= 1'd0;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        sof_1_fu_98 <= 1'd1;
    end
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_274_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        xi_reg_162 <= 11'd0;
    end else if (((tmp_s_fu_286_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        xi_reg_162 <= xi_1_fu_292_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        yi_reg_139 <= yi_1_reg_421;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        yi_reg_139 <= 10'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_reg_pp1_iter1_tmp_s_reg_426 <= tmp_s_reg_426;
        tmp_s_reg_426 <= tmp_s_fu_286_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp1_stage0_11001)) begin
        ap_reg_pp1_iter2_tmp_s_reg_426 <= ap_reg_pp1_iter1_tmp_s_reg_426;
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_s_fu_286_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        brmerge_reg_435 <= brmerge_fu_301_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        p_1_cast_reg_444 <= {{ap_phi_mux_axis_reader_data_V_2_phi_fu_212_p4[15:8]}};
        p_s_reg_439 <= p_s_fu_373_p2;
        tmp_3_reg_449 <= {{ap_phi_mux_axis_reader_data_V_2_phi_fu_212_p4[23:16]}};
    end
end

always @ (posedge ap_clk) begin
    if (((ap_reg_pp1_iter1_tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        phitmp2_reg_454 <= phitmp2_fu_365_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((axis_src_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_data_V_reg_397 <= axis_src_V_data_V_0_data_out;
        tmp_last_V_reg_405 <= axis_src_V_last_V_0_data_out;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        yi_1_reg_421 <= yi_1_fu_280_p2;
    end
end
...
always @ (*) begin
    if (((exitcond_fu_274_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((ap_reg_pp1_iter1_tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
        ap_phi_mux_axis_reader_data_V_1_phi_fu_187_p4 = axis_reader_data_V_2_reg_208;
    end else begin
        ap_phi_mux_axis_reader_data_V_1_phi_fu_187_p4 = axis_reader_data_V_1_reg_184;
    end
end

always @ (*) begin
    if ((1'b1 == ap_condition_412)) begin
        if ((brmerge_reg_435 == 1'd1)) begin
            ap_phi_mux_axis_reader_data_V_2_phi_fu_212_p4 = ap_phi_mux_axis_reader_data_V_1_phi_fu_187_p4;
        end else if ((brmerge_reg_435 == 1'd0)) begin
            ap_phi_mux_axis_reader_data_V_2_phi_fu_212_p4 = axis_src_V_data_V_0_data_out;
        end else begin
            ap_phi_mux_axis_reader_data_V_2_phi_fu_212_p4 = ap_phi_reg_pp1_iter1_axis_reader_data_V_2_reg_208;
        end
    end else begin
        ap_phi_mux_axis_reader_data_V_2_phi_fu_212_p4 = ap_phi_reg_pp1_iter1_axis_reader_data_V_2_reg_208;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_412)) begin
        if ((brmerge_reg_435 == 1'd1)) begin
            ap_phi_mux_axis_reader_last_V_2_phi_fu_200_p4 = ap_phi_mux_eol_1_phi_fu_176_p4;
        end else if ((brmerge_reg_435 == 1'd0)) begin
            ap_phi_mux_axis_reader_last_V_2_phi_fu_200_p4 = axis_src_V_last_V_0_data_out;
        end else begin
            ap_phi_mux_axis_reader_last_V_2_phi_fu_200_p4 = ap_phi_reg_pp1_iter1_axis_reader_last_V_2_reg_195;
        end
    end else begin
        ap_phi_mux_axis_reader_last_V_2_phi_fu_200_p4 = ap_phi_reg_pp1_iter1_axis_reader_last_V_2_reg_195;
    end
...
always @ (*) begin
    if (((ap_reg_pp1_iter1_tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter2 == 1'b1))) begin
        ap_phi_mux_eol_1_phi_fu_176_p4 = axis_reader_last_V_2_reg_195;
    end else begin
        ap_phi_mux_eol_1_phi_fu_176_p4 = eol_1_reg_173;
    end
end

always @ (*) begin
    if (((eol_2_reg_220 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
        ap_phi_mux_eol_2_phi_fu_223_p4 = axis_src_V_last_V_0_data_out;
    end else begin
        ap_phi_mux_eol_2_phi_fu_223_p4 = eol_2_reg_220;
    end
end

always @ (*) begin
    if (((tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_eol_phi_fu_154_p4 = ap_phi_mux_axis_reader_last_V_2_phi_fu_200_p4;
    end else begin
        ap_phi_mux_eol_phi_fu_154_p4 = eol_reg_150;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_reg_220 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_reg_435 == 1'd0) & (tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if ((((eol_2_reg_220 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op50_read_state6 == 1'b1)) | ((axis_src_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((ap_reg_pp1_iter2_tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter3 == 1'b1))) begin
...
always @ (*) begin
    if (((ap_reg_pp1_iter2_tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter3 == 1'b1))) begin
        fifo1_write = 1'b1;
    end else begin
        fifo1_write = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_265_p1 == 1'd0) & (axis_src_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_265_p1 == 1'd1) & (axis_src_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((ap_reg_pp1_iter2_tmp_s_reg_426 == 1'd0) & (fifo1_full_n == 1'b0) & (ap_enable_reg_pp1_iter3 == 1'b1)) | ((axis_src_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (ap_predicate_op50_read_state6 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((ap_reg_pp1_iter2_tmp_s_reg_426 == 1'd0) & (fifo1_full_n == 1'b0) & (ap_enable_reg_pp1_iter3 == 1'b1)) | ((axis_src_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (ap_predicate_op50_read_state6 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((ap_reg_pp1_iter2_tmp_s_reg_426 == 1'd0) & (fifo1_full_n == 1'b0) & (ap_enable_reg_pp1_iter3 == 1'b1)) | ((axis_src_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (ap_predicate_op50_read_state6 == 1'b1)));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_reg_220 == 1'd0) & (axis_src_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_reg_220 == 1'd0) & (axis_src_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state11_pp2_stage0_iter1 = ((eol_2_reg_220 == 1'd0) & (axis_src_V_data_V_0_vld_out == 1'b0));
end
...
always @ (*) begin
    ap_block_state8_pp1_stage0_iter3 = ((ap_reg_pp1_iter2_tmp_s_reg_426 == 1'd0) & (fifo1_full_n == 1'b0));
end

always @ (*) begin
    ap_condition_409 = ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end

always @ (*) begin
    ap_condition_412 = ((tmp_s_reg_426 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axis_reader_data_V_2_reg_208 = 'bx;

assign ap_phi_reg_pp1_iter1_axis_reader_last_V_2_reg_195 = 'bx;

always @ (*) begin
    ap_predicate_op50_read_state6 = ((brmerge_reg_435 == 1'd0) & (tmp_s_reg_426 == 1'd0));
end
...
assign brmerge_fu_301_p2 = (sof_1_fu_98 | ap_phi_mux_eol_phi_fu_154_p4);

assign exitcond_fu_274_p2 = ((yi_reg_139 == 10'd720) ? 1'b1 : 1'b0);

assign fifo1_din = phitmp2_reg_454;

assign grp_fu_379_p0 = 25'd38469;

assign grp_fu_379_p1 = grp_fu_379_p10;

assign grp_fu_379_p10 = p_1_cast_reg_444;

assign grp_fu_379_p2 = grp_fu_379_p20;

assign grp_fu_379_p20 = grp_fu_389_p3;

assign grp_fu_389_p0 = 23'd19595;

assign grp_fu_389_p1 = grp_fu_389_p10;

assign grp_fu_389_p10 = tmp_3_reg_449;

assign p_s_fu_373_p0 = 23'd9437;

assign p_s_fu_373_p1 = p_s_fu_373_p10;

assign p_s_fu_373_p10 = r_V_fu_312_p1;

assign phitmp2_fu_365_p3 = ((tmp_21_fu_349_p3[0:0] === 1'b1) ? 8'd255 : tmp_8_fu_356_p4);

assign r_V_fu_312_p1 = ap_phi_mux_axis_reader_data_V_2_phi_fu_212_p4[7:0];

assign start_out = real_start;

assign tmp_21_fu_349_p3 = grp_fu_379_p3[32'd24];

assign tmp_8_fu_356_p4 = {{grp_fu_379_p3[23:16]}};

assign tmp_s_fu_286_p2 = ((xi_reg_162 == 11'd1280) ? 1'b1 : 1'b0);

assign tmp_user_V_fu_265_p1 = axis_src_V_user_V_0_data_out;

assign xi_1_fu_292_p2 = (xi_reg_162 + 11'd1);

assign yi_1_fu_280_p2 = (yi_reg_139 + 10'd1);
