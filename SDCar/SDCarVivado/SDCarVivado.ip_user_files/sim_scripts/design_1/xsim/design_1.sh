...
{
  file="xsim.ini"
  lib_map_path="/home/catabit/.opt/Xilinx/Vivado/2017.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib fifo_generator_v13_2_1 axis_infrastructure_v1_1_0 axis_data_fifo_v1_1_16)
